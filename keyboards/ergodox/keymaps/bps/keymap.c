 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |  L1  |           |  L1  |   Y  |   U  |   I  |   O  |   P  | Backsp |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LCtrl  |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2| Enter  |
 * |--------+------+------+------+------+------| Hyper|           | Meh  |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  L1  |  '"  |AltShf| LGui | Right|                                       |  Up  | Down |   [  |   ]  | L1   |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | ←   |  ↓  |       | ↑   |  →  |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 | Space|Backsp|------|       |------|  L1    |Space |
 *                                 |      |ace   | End  |       | PgDn |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        MO(1),          KC_QUOT,      LALT(KC_LSFT),  KC_LGUI,KC_LALT,
                                               KC_LEFT,       KC_RGHT,
                                                              KC_HOME,
        ...
        MEH_T(KC_NO),  KC_N,   KC_M,    KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
                              KC_RALT, KC_DOWN,KC_LBRC,KC_RBRC,           MO(1),
        KC_DOWN,       KC_UP,
        KC_PGUP,
        KC_PGDN,MO(1), KC_SPC
    ),
...
[SYMB] = KEYMAP(
       ...
       KC_LCTRL,KC_LEFT,KC_DOWN, KC_RIGHT,KC_RPRN,KC_GRV,
       ...
       KC_TRNS, KC_UP,   KC_7,   KC_8,    KC_9,    KC_UP,   KC_DEL,
                KC_TRNS, KC_TRNS,KC_TRNS, KC_LEFT, KC_RIGHT,KC_TRNS,
